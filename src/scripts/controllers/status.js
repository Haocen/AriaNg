(function () {
    ...
    angular.module('ariaNg').controller('Aria2StatusController', ['$rootScope', '$scope', 'ariaNgLocalizationService', 'ariaNgSettingService', 'aria2SettingService', 'ariaNgDefaultOptions', function ($rootScope, $scope, ariaNgLocalizationService, ariaNgSettingService, aria2SettingService, ariaNgDefaultOptions) {
        $scope.context = {
